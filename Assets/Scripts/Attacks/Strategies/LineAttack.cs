...
namespace Maihem.Attacks.Strategies
{
    ...
    {
        [Header("Line Attack Settings")] [Min(1)] [SerializeField]
        private int range = 3;
            ...
            bool isPlayerAttack)
        {
            ...
            for (var i = 1; i <= range; i++)
            {
                ...
                var adjustedDamage = math.max(0,
                    invertDamageFalloff ? Damage - (range - i) * damageFalloff : Damage - damageFalloff * (i - 1));
